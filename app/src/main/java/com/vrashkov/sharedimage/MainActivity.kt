package com.vrashkov.sharedimage
...
import com.vrashkov.sharedimage.ui.theme.SharedImageTheme
            ...
            Image(
                ...
                modifier = Modifier.fillMaxSize()
                    ...
                    coroutineScope.launch {
                        sharedViewModel.sharedImageFlow.emit(SharedImageDataEvent.ForwardImage(
                            imageData
                        ))

                        sharedViewModel.sharedImageFlow.emit(SharedImageDataEvent.SetImage(
                            imageId
                        ))
